...
import footerBgColor from '../assets/images/footer-bg-color.png'

const Contact = () => {
  return (
    <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20 bg-no-repeat bg-[length:90%_auto] bg-center dark:bg-none" style={{ backgroundImage: `url(${footerBgColor})` }}>
      ...
      <form method="POST" action="https://api.web3forms.com/submit" className="max-w-2x1 mx-auto">
